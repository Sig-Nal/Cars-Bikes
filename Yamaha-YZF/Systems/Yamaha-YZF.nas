...
setlistener("/surface-positions/left-aileron-pos-norm", func{
	...
	var omm = getprop("/controls/Yamaha-YZF/old-mens-mode") or 0;
	...
	var driverpos = getprop("/controls/Yamaha-YZF/driver-up") or 0;
...
setlistener("/instrumentation/Yamaha-YZF/speed-indicator/speed-limiter", func (sl){
...
setlistener("sim/model/start-idling", func()
 ...
 setlistener("/controls/gear/brake-parking", func(p)
  ...
  if (p.getValue() == 1)
   {
   		interpolate("/controls/Yamaha-YZF/driver-up", 1, 0.8);
   }
  else
   {
   		interpolate("/controls/Yamaha-YZF/driver-up", 0, 0.8);
   }
  }, 1, 0);
